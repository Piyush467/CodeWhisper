...
const reviewController = {
  ...
  review: asyncHandler(async (req, res) => {
    ...
    let reviewResult = cacheService.get(cacheKey);
    ...
    if (!reviewResult) {
      ...
      if (reviewResult && !reviewResult.isFallback) {
        cacheService.set(cacheKey, reviewResult);
      }
    }
    ...
    logger.info(`Code review completed & saved. ID: ${savedReview._id}. Cached: ${isFromCache}`);
